...
CUDA_VISIBLE_DEVICES="2,3" python train.py --model_type flowformer_vio_lstm --regression_mode 2 --batch_size 48 --data_dir ./data --experiment_name flowformer_vio_lstm_regress_mode_2_update_lstm --seq_len 11 --workers 32 --patch_size 16 --epochs_warmup 20 --epochs_joint 80 --epochs_fine 40 --img_w 480 --img_h 216 --stage kitti --pretrain ./model_zoo/flowformer_kitti.pth
