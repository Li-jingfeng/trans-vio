...
import numpy as np
# pwc本来的corr
from pwc_correlation import FunctionCorrelation
# flownet
...
class PWCDCNet(nn.Module):
    ...
    def concate_two_layers(self, pred_func, decon_func, upfeat_func, feat_high, feat_low1, feat_low2, scale):
        ...
        # corr_low = correlate(feat_low1, warp_feat)
    ...
    def forward(self,x):
        ...
        corr6 = FunctionCorrelation(tenFirst=c16, tenSecond=c26)# [16,81,4,8]
        # corr6 = correlate(c16, c26)  # 这与raft之类的cost volume不太一样
